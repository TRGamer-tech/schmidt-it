...
function toggleLanguage() {
  ...
  localStorage.setItem(
    "language",
    document.querySelector(".en").classList.contains("hidden") ? "de" : "en"
  );
}
...
document
  .getElementById("mobile-language-toggle")
  .addEventListener("click", toggleLanguage);
document
  .getElementById("footer-language-toggle")
  .addEventListener("click", toggleLanguage);
...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    alert(
      document.querySelector(".en").classList.contains("hidden")
